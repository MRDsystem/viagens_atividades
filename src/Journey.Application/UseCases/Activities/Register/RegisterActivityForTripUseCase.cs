...
namespace Journey.Application.UseCases.Activities.Register
{
    public class RegisterActivityForTripUseCase
    {
        ...
        private void Validate(Trip trip, RequestRegisterActivityJson request)
        {
            ...
            {
                result.Errors.Add(new FluentValidation.Results.ValidationFailure("Date",ResourceErrorMessages.DATE_NOT_WITHIN_TRAVEL_PERIOD)); // Paramero Date não faz diferença, mas precisa ter algum parametro lá
            }
